...
{
    public static final String FIREBASE_SDK_JSON ="C:\\Users\\Chandana I K\\Downloads\\drivelistfilesapplication-firebase-adminsdk-ny679-8a0c60eb7d.json";//copy the sdk-config file root address, if its in root ,filename is enough
